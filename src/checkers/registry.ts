...
export const CHECKER_REGISTRY: CheckerDescriptor[] = [
  ...
  { key: 'structuredData', label: 'Structured Data', icon: '📋', create: (ctx) => new StructuredDataChecker(ctx.page) },
  { key: 'socialMedia', label: 'Social Media', icon: '📱', create: (ctx) => new SocialMediaChecker(ctx.page) },
