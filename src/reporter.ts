...
const SECTIONS: Array<{ key: keyof SEOReport['checks']; label: string; icon: string }> = [
  { key: 'metaTags',             label: 'Meta Tags',             icon: '🏷️' },
  ...
  { key: 'structuredData',       label: 'Structured Data',       icon: '📋' },
  { key: 'socialMedia',          label: 'Social Media',          icon: '📱' },
  { key: 'content',              label: 'Content',               icon: '📄' },
  { key: 'links',                label: 'Links',                 icon: '🔗' },
  { key: 'uiElements',           label: 'UI Elements',           icon: '🎨' },
  { key: 'technical',            label: 'Technical SEO',         icon: '⚙️' },
  { key: 'accessibility',        label: 'Accessibility',         icon: '♿' },
  { key: 'urlFactors',           label: 'URL Factors',           icon: '🌐' },
  { key: 'spamDetection',        label: 'Spam Detection',        icon: '🚫' },
  { key: 'pageQuality',          label: 'Page Quality',          icon: '⭐' },
  { key: 'advancedImages',       label: 'Advanced Images',       icon: '📷' },
  ...
  { key: 'mobileUX',             label: 'Mobile UX',             icon: '📲' },
  { key: 'schemaValidation',     label: 'Schema Validation',     icon: '✅' },
  { key: 'resourceOptimization', label: 'Resource Optimization', icon: '🚀' },
  { key: 'legalCompliance',      label: 'Legal & Compliance',    icon: '⚖️' },
  { key: 'ecommerce',            label: 'E-commerce',            icon: '🛒' },
  { key: 'internationalization', label: 'Internationalization',  icon: '🌍' },
  { key: 'heatmap',              label: 'Heatmap & UX',          icon: '🔥' },
];
...
<main class="main">
  ...
  <div class="issues-section">
    ...
    <div class="overview-grid">
      ${categorySummaries.map(({ key, label, icon, p, t, pct, catColor }) => `
...
<footer class="footer">
  Generated by <strong>e2e-seo</strong> &mdash; ${new Date(report.timestamp).toISOString()}
</footer>
